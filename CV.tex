...
\resumeSmallHeading
{\textbf{Technologies}:\badges{{Docker, Kubernetes, ExpressJS, Sonatype Nexus, Burp Suite}}}

\resumeSmallHeading
{\textbf{Misc.}:\badges{{Linux, SQL, HTML/CSS, Grafana, REST API, WebSockets, JSON, Selenium, Telethon}}}
